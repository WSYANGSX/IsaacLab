...
def run_simulator(
    ...
    rot_diff = normalize(quat_mul(target_frame_quat, quat_conjugate(init_frame_quat)))
    w = rot_diff[:, 0]
    a = rot_diff[:, 1]
    b = rot_diff[:, 2]
    c = rot_diff[:, 3]
    ...
    _angle = rotation_distance(init_frame_quat, target_frame_quat)
    
    angle_delta = _angle / steps
    ...
    while simulation_app.is_running():
        ...
        middle_frame_quat = quat_mul(quat_delat, middle_frame_quat)
