import numpy as np
from my_project.rl_projects.gmm_gmr.utils import trajectories_time_align, gaussian
...
class GMM_GMR(object):
    ...
    def __init__(self, trajectories, n_components):
        ...
        if isinstance(trajectories, list):
            self.trajectories = np.array(trajectories_time_align(trajectories))
    ...
    def fit(self):
        ...
        print(
            "Explained variance: {}%".format(np.sum(self.pca.explained_variance_ratio_))
        )
