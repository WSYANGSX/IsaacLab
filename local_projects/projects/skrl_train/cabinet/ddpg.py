...
env = load_isaaclab_env(task_name="Isaac-Franka-Cabinet-Direct-v0", num_envs=64)
env = wrap_env(env)
...
memory1 = RandomMemory(memory_size=15625, num_envs=env.num_envs, device=device)
memory2 = RandomMemory(memory_size=15625, num_envs=env.num_envs, device=device)
...
models2 = {}
models2["policy"] = DeterministicActor(env.observation_space, env.action_space, device)
models2["target_policy"] = DeterministicActor(
    env.observation_space, env.action_space, device
)
models2["critic"] = Critic(env.observation_space, env.action_space, device)
models2["target_critic"] = Critic(env.observation_space, env.action_space, device)
