...
env = load_isaaclab_env(task_name="Isaac-Franka_Prtpr-Direct-JointSpace-v0", num_envs=96)
env = wrap_env(env)
...
cfg["experiment"]["directory"] = "runs/torch/Isaac-Franka_Prtpr-Direct-JointSpace-v0"
