...
env = load_isaaclab_env(task_name="Isaac-Open_Pick_Place-Direct-v0", num_envs=1024)
env = wrap_env(env)
...
cfg["experiment"]["directory"] = "runs/torch/Isaac-Open_Pick_Place-Direct-v0-PPO-Dense"
